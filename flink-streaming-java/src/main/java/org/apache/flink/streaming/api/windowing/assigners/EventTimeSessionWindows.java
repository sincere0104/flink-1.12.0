 ...
 * TODO 如果新到来的元素和前一个元素的时间差小于gap，后来的元素会进入到之前元素的window中，否则，新的元素会进入到新的window。
...
public class EventTimeSessionWindows extends MergingWindowAssigner<Object, TimeWindow> {
	...
	public Collection<TimeWindow> assignWindows(Object element, long timestamp, WindowAssignerContext context) {
		//直接返回start为timestamp，end为timestamp + sessionTimeout的window，合并window的操作在WindowOperator中，会生成时间跨度覆盖满足session window定义元素的window。
